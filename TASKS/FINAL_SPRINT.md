...
ChatGPT, Grok Chat/Grok Work e Gemini Spark estão trabalhando como uma única equipe sobre o mesmo hub. O GitHub é a fonte comum. Cada agente deve ler o trabalho dos outros somente depois de produzir sua própria parte quando isso preservar independência; depois disso, deve convergir para a entrega.
...
- Grok Work: executor principal de FMDL/FTEX/FPK/Blender/scripts.
...
1. Grok Work cria UM candidato offline completo.
...
4. Grok Work corrige somente bloqueadores reais.
...
## Entregas obrigatórias do Grok Work
Na branch `work/v4`:
...
- revisar o candidato final do Work;
